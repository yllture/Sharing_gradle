...
import com.neu.Sharing.cpabe.ac.AccessStructure;
import com.neu.Sharing.cpabe.component.*;
import com.neu.Sharing.cpabe.key.PersonalKey;
import com.neu.Sharing.cpabe.key.SecretKey;
import com.neu.Sharing.cpabe.utility.Utility;
...
//			System.out.println(ak.getSecretKeys().get("a").hashCode());
            return true;
