...
public class Bank_multiple {
    ...
    private List<Bank_multiplechoice> multiplelist;
    ...
    public List<Bank_multiplechoice> getMultiplelist() {
		return multiplelist;
	}

	public void setMultiplelist(List<Bank_multiplechoice> multiplelist) {
