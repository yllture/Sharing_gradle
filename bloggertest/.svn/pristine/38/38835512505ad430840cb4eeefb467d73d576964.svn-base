...
(function() {
	...
	d.AmSlicedChart = d.Class({
		...
		construct: function(a) {
			...
			this.colors = "#5FB878 #FFB800 #1E9FFF #e2e2e2 #F8FF01 #B0DE09 #04D215 #0D8ECF #0D52D1 #2A0CD0 #8A0CCF #CD0D74 #754DEB #DDDDDD #999999 #333333 #000000 #57032A #CA9726 #990000 #4B0C25".split(" ");
			this.alpha = 1;
			this.groupPercent = 0;
