...
public class Paper_single {
    ...
    private Integer c3;
    private List<Paper_singlechoice> singlelist;

    public List<Paper_singlechoice> getSinglelist() {
		return singlelist;
	}

	public void setSinglelist(List<Paper_singlechoice> singlelist) {
